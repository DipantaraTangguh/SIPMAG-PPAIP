/**
 * MandiriEmptyState.jsx
 * Displayed when user has no Form 2 submissions in the Mandiri tab.
 *
...
export default function MandiriEmptyState({ onCreateNew, isLocked = false }) {
    return (
