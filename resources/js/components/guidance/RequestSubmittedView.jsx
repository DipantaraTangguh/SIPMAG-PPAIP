/**
 * components/bimbingan/PengajuanSubmittedView.jsx
 * Submitted pengajuan view — shows readonly data + side panel.
 * Extracted from BimbinganPage.jsx lines 256–466.
 */
import React from 'react';
import { BookOpen, Check, Info, Eye, Calendar } from 'lucide-react';

export default function PengajuanSubmittedView({ data, studentName, studentNim }) {
    return (
