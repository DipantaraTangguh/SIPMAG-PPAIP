/**
 * components/bimbingan/PengajuanDPMAssignedView.jsx
 * DPM assigned view for Bimbingan page — shows DPM profile, info, and action buttons.
 * Extracted from BimbinganPage.jsx lines 119–253.
 */
import React from 'react';
import { CheckCircle, BookOpen, Check, Info, Mail } from 'lucide-react';

export default function PengajuanDPMAssignedView({ dpm, onGoToLogbook }) {
    return (
