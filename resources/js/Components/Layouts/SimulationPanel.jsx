...
import AuthControls from '../Fragments/simulation/AuthControls';
import Form1Controls from '../Fragments/simulation/Form1Controls';
import Form2Controls from '../Fragments/simulation/Form2Controls';
import SupervisorControls from '../Fragments/simulation/SupervisorControls';
import LogbookControls from '../Fragments/simulation/LogbookControls';
import DefenseControls from '../Fragments/simulation/DefenseControls';
import QuickNavigation from '../Fragments/simulation/QuickNavigation';
        ...
        <div className="fixed bottom-4 right-4 z-[9999] w-[240px] select-none">
            ...
            {open && (
                <div className="flex max-h-[70vh] flex-col gap-3 overflow-y-auto rounded-b-xl bg-gray-900 px-4 pb-4 pt-3">
                    ...
                    <SupervisorControls sim={sim} status={status} />
                    <LogbookControls sim={sim} status={status} />
                    <DefenseControls sim={sim} status={status} />
