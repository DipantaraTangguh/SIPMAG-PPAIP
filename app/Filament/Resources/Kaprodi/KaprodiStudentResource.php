...
class KaprodiStudentResource extends Resource
{
    ...
    public static function table(Table $table): Table
    {
        return $table
            ...
            ->bulkActions(static::pileBulkActions());
    }

    /**
     * Penjadwalan sidang serentak: tanggal, waktu, ruang, dan penguji yang
     * sama diterapkan ke semua mahasiswa terpilih yang sudah siap sidang.
     *
     * Tidak dipasang di tabel bersama melainkan ditawarkan lewat
     * pileBulkActions(), karena tumpukan lain tidak pernah memuat baris
     * yang siap dijadwalkan -- di halaman Review Form 1 tombolnya hanya
     * akan melaporkan semua barisnya dilewati.
     */
    protected static function scheduleSidangBulkAction(): Tables\Actions\BulkAction
    {
        return Tables\Actions\BulkAction::make('scheduleSidangBulk')
    ...
    /**
     * Aksi massal milik tiap tumpukan. Kosong secara bawaan supaya tidak
     * ada tombol yang ikut terwarisi ke halaman yang tidak memerlukannya.
     *
